...
import { listConversions, type ConversionRow } from "@/lib/peppol/conversions";
...
function Dashboard() {
  ...
  useEffect(() => {
    if (user) void listConversions().then(setRows).catch(() => setRows([]));
  }, [user]);
